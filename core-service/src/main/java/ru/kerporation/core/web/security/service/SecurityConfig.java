...
import ru.kerporation.core.web.security.jwt.JwtProperties;
import ru.kerporation.core.web.security.jwt.JwtTokenFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(final HttpSecurity security) {
        security.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(configurer -> configurer.requestMatchers("/api/v*/auth/**").permitAll().anyRequest().authenticated())
                .anonymous(AbstractHttpConfigurer::disable).addFilterBefore(new JwtTokenFilter(tokenService(), userDetailsService), UsernamePasswordAuthenticationFilter.class);
