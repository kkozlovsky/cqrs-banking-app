package ru.kerporation.cqrsbankingapp.web.security.jwt;
...
public class JwtTokenFilter extends GenericFilterBean {
    ...
    public void doFilter(final ServletRequest req,
        ...
        try {
            final String token = resolve((HttpServletRequest) req);
            if (!token.isEmpty() && jwtService.getType(token).equals(TokenType.ACCESS.name()) && !jwtService.isExpired(token)) {
